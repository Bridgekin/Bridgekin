  ...
  return (
    <div>
      ...
      <Typography variant="body2" align='left' gutterBottom>
        ...
        <br></br>
        <ul>
          <li>{`Details of your visits to our Website, including traffic data, location data, logs, search requests, browsing history of listings, selections of listings, posting of listings, successful connections between users, other use history,  and other communication data and the resources that you access and use on the Website.`}</li>
      ...
      <Typography variant="body2" align='left' gutterBottom>
        ...
        <ul>
          ...
          <li>{`To provide you with information and to connect you with other users who are interested in your posted listings or who are associated with opportunities you tell us you are interested in exploring. This is the purpose of the Website and by registering with the Website, you consent to the transmission of your personal information including email address, name and interest or association with a posted listing to other users.  If you do not consent, you should not use or register with this Website.`}</li>
          <li>{`To provide information to those you referral contacts regarding your referral.`}</li>
          ...
          <li>{`To track and understand user behavior including user searches, user selection of interested listings, user requests for connections to other suers, and other user history.`}</li>
      ...
      <Typography variant="body2" align='left' gutterBottom>
        ...
        <ul>
          ...
          <li>{`To fulfill the purpose for which you provide it.  For example, if you give us an email address to use for a subscription to notify you of new listings and opportunities, we will transmit the update notices to your email.`}</li>
          <li>{`To fulfill the purpose of the Website which is to make introductions between a user who indicates an interest in a particular listing and the user or users who are associated with that posted listing.  For example, the email address you provide in your profile will be used to make an introduction between you and the user who either has a listing that interests you or has indicated an interest in one of your listings.  We will transmit your email address to the other user along with an indication of your listing or your interest, as applicable.`}</li>
      ...
      <br></br>
      <Typography variant="body2" align='left' gutterBottom>
        {`We have implemented measures designed to secure your personal information from accidental loss and from unauthorized access, use, alteration, and disclosure. All information you provide to us such as personally identifiable information, payment information and login credentials, is stored on our secure servers and will be encrypted using SSL technology.`}
      </Typography>
      <br></br>
      <Typography variant="body2" align='left' gutterBottom>
